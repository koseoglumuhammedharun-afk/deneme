...
def create_live_analysis_ui(main_layout, parent_window):
    ...
    parent_window.live_play_btn = QPushButton("Oynat / Devam")
    ...
    parent_window.live_current_time_label.setMinimumWidth(50)
    ...
    parent_window.live_total_time_label.setMinimumWidth(50)
